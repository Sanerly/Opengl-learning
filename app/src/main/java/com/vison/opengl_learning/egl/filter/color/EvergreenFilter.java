...
public class EvergreenFilter extends AFilter {
    ...
    public EvergreenFilter(String vertexShader, String fragmentShader) {
        ...
        mCurveTextureLoc = GLES30.glGetUniformLocation(mProgram, "curveTexture");
        createTexture();
    }
    ...
    private void createTexture() {
        ...
        mCurveTexture = GlUtils.createTexture(arrayOfByte, 256, 1);
    }
