...
public class SketchFilter extends AFilter {
    private static final String FRAGMENT_SHADER =
            ...
            "    float threshold = 0.0;                                             \n" +
            "    //pic1                                                             \n" +
            "    vec4 oralColor = texture2D(uTexture, vCoordinate);       \n" +
            "                                                                       \n" +
            "    //pic2                                                             \n" +
            ...
            "        for(int j = -2; j<=2; j++)                                     \n" +
            "        {                                                              \n" +
            "            vec4 tempColor = texture2D(uTexture,                   \n" +
            "                   vCoordinate + singleStepOffset * vec2(i, j)); \n" +
    ...
    public SketchFilter(String vertexShader, String fragmentShader) {
        ...
        mSingleStepOffsetLoc = GLES20.glGetUniformLocation(mProgram, "singleStepOffset");
        mStrengthLoc = GLES20.glGetUniformLocation(mProgram, "strength");
        setStrength(0.5f);
    }
